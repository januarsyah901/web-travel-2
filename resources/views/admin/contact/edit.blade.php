...
@section('title', 'Edit Kontak - Admin Fabi Abadi')
...
<div style="max-width: 800px; margin: 0 auto;" class="space-y-6">
    ...
    <div style="display:flex; align-items:center; justify-content:space-between; gap:16px;">
        <div>
            <h1 style="font-size:20px; font-weight:600; color:var(--color-charcoal); margin:0 0 4px;">Edit Kontak Perusahaan</h1>
            <p style="font-size:14px; color:var(--color-fog); margin:0;">Perbarui informasi kontak, media sosial, dan Google Maps embed.</p>
        </div>
    ...
    @if ($errors->any())
        <div class="dub-card" style="border-color:#fecaca; background:#fef2f2; padding:12px 16px; color:#991b1b;">
            <p style="font-size:13px; font-weight:600; margin:0 0 4px;">Terdapat beberapa kesalahan:</p>
    ...
    <div class="dub-card" style="padding:24px;">
        <form method="POST" action="{{ route('contact.update', $contact->id) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap:16px;">
                    <div>
                        ...
                        <input type="text" name="company_name" id="company_name" value="{{ old('company_name', $contact->company_name) }}" placeholder="Contoh: PT Fabi Abadi Travel" class="dub-input" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="whatsapp" id="whatsapp" value="{{ old('whatsapp', $contact->whatsapp) }}" placeholder="Contoh: 081234567890 atau 6281234567890" class="dub-input" required>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email', $contact->email) }}" placeholder="info@fabiabadi.com" class="dub-input" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="working_hours" id="working_hours" value="{{ old('working_hours', $contact->working_hours) }}" placeholder="Senin - Sabtu: 08.00 - 17.00" class="dub-input">
                    </div>
                </div>
                ...
                <div style="margin-top:16px;">
                    ...
                    <textarea name="address" id="address" rows="3" class="dub-input resize-none" required>{{ old('address', $contact->address) }}</textarea>
                </div>
            </div>
            ...
            <div>
                ...
                <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap:12px;">
                    <div>
                        ...
                        <input type="url" name="facebook" id="facebook" value="{{ old('facebook', $contact->facebook) }}" placeholder="https://facebook.com/username" class="dub-input">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" name="instagram" id="instagram" value="{{ old('instagram', $contact->instagram) }}" placeholder="https://instagram.com/username" class="dub-input">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" name="twitter" id="twitter" value="{{ old('twitter', $contact->twitter) }}" placeholder="https://twitter.com/username" class="dub-input">
                    </div>

                    <div>
                        <label for="youtube" class="block text-xs text-[var(--color-fog)] mb-1"><i class="fab fa-youtube" style="color:#FF0000;"></i> YouTube</label>
                        <input type="url" name="youtube" id="youtube" value="{{ old('youtube', $contact->youtube) }}" placeholder="https://youtube.com/@username" class="dub-input">
                    </div>

                    <div>
                        <label for="tiktok" class="block text-xs text-[var(--color-fog)] mb-1"><i class="fab fa-tiktok"></i> TikTok</label>
                        <input type="url" name="tiktok" id="tiktok" value="{{ old('tiktok', $contact->tiktok) }}" placeholder="https://tiktok.com/@username" class="dub-input">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" name="linkedin" id="linkedin" value="{{ old('linkedin', $contact->linkedin) }}" placeholder="https://linkedin.com/company/nama" class="dub-input">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" name="pinterest" id="pinterest" value="{{ old('pinterest', $contact->pinterest) }}" placeholder="https://pinterest.com/username" class="dub-input">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" name="telegram" id="telegram" value="{{ old('telegram', $contact->telegram) }}" placeholder="https://t.me/username" class="dub-input">
                    </div>
                </div>
            </div>
            ...
            <div id="maps_embed">
                ...
                <div>
                    ...
                    <textarea name="maps_embed" rows="4" placeholder='<iframe src="https://www.google.com/maps/embed?..." width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>' class="dub-input resize-none font-mono" style="font-size:13px;">{{ old('maps_embed', $contact->maps_embed) }}</textarea>
            ...
            <div style="display:flex; align-items:center; gap:8px;">
                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $contact->is_active) ? 'checked' : '' }} style="width:16px; height:16px; cursor:pointer;">
            ...
            <div style="display:flex; justify-content:flex-end; gap:8px; padding-top:16px; border-top:1px solid var(--color-ash);">
                ...
                <button type="submit" class="dub-btn dub-btn-primary">
                    <i class="fas fa-check" style="font-size:12px;"></i> Update Kontak
                </button>
            </div>
        </form>
    </div>

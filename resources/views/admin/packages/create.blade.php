...
@section('title', 'Tambah Paket - Admin Fabi Abadi')
...
<div style="max-width: 768px; margin: 0 auto;" class="space-y-6">
    ...
    <div style="display:flex; align-items:center; justify-content:space-between; gap:16px;">
        <div>
            <h1 style="font-size:20px; font-weight:600; color:var(--color-charcoal); margin:0 0 4px;">Tambah Paket Umroh</h1>
            <p style="font-size:14px; color:var(--color-fog); margin:0;">Buat paket perjalanan ibadah baru.</p>
        </div>
    ...
    <div class="dub-card" style="padding:24px;">
        <form method="POST" action="{{ route('packages.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Contoh: Paket Umroh Ramadhan 2026" class="dub-input" required>
            </div>
            ...
            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap:16px;">
                <div>
                    ...
                    <input type="text" name="schedule" id="schedule" value="{{ old('schedule') }}" placeholder="Contoh: 15 Maret 2026" class="dub-input" required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="duration" id="duration" value="{{ old('duration') }}" placeholder="Contoh: 9" min="1" class="dub-input" required>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="number" name="price" id="price" value="{{ old('price') }}" placeholder="Contoh: 25000000" min="0" step="100000" class="dub-input" required>
            ...
            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap:16px;">
                <div>
                    ...
                    <input type="text" name="hotel_makkah" id="hotel_makkah" value="{{ old('hotel_makkah') }}" placeholder="Contoh: Hilton Makkah" class="dub-input">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="hotel_madinah" id="hotel_madinah" value="{{ old('hotel_madinah') }}" placeholder="Contoh: Anwar Al Madinah Mövenpick" class="dub-input">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" placeholder="Jelaskan detail fasilitas, hotel, dan keunggulan paket..." class="dub-input resize-none">{{ old('description') }}</textarea>
            </div>
            ...
            <div style="display:flex; justify-content:flex-end; gap:8px; padding-top:16px; border-top:1px solid var(--color-ash);">
                ...
                <button type="submit" class="dub-btn dub-btn-primary">
                    <i class="fas fa-save" style="font-size:12px;"></i> Simpan Paket
                </button>
            </div>
        </form>
    </div>

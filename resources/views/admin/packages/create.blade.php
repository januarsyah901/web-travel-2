...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div class="flex items-center gap-5">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Tambah Paket Umroh</h1>
                <p class="text-gray-500 text-sm mt-1">Buat paket perjalanan ibadah baru.</p>
            </div>
        </div>
    ...
    <form method="POST" action="{{ route('packages.store') }}" class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        @csrf
        ...
        <div class="p-6 md:p-8 space-y-8">
            ...
            <div class="space-y-6">
                <div class="space-y-2">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Contoh: Paket Umroh Ramadhan 2026" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none" required>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="schedule" id="schedule" value="{{ old('schedule') }}" placeholder="Contoh: 15 Maret 2026" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none" required>
                    </div>

                    <div class="space-y-2">
                        <label for="duration" class="text-sm font-semibold text-gray-700">Durasi (Hari) <span class="text-red-500">*</span></label>
                        <input type="number" name="duration" id="duration" value="{{ old('duration') }}" placeholder="Contoh: 9" min="1" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none" required>
                    </div>
                </div>

                <div class="space-y-2">
                    <label for="price" class="text-sm font-semibold text-gray-700">Harga Paket (Rp) <span class="text-red-500">*</span></label>
                    <input type="number" name="price" id="price" value="{{ old('price') }}" placeholder="Contoh: 25000000" min="0" step="100000" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none" required>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" id="description" rows="5" placeholder="Jelaskan detail paket umroh, termasuk fasilitas dan keunggulan..." class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none resize-none">{{ old('description') }}</textarea>
                </div>
            </div>
    ...
    <div class="mt-6 flex gap-3 p-4 bg-blue-50 border border-blue-100 rounded-xl text-blue-800 text-sm">
        ...
        <div>
            ...
            <ul class="list-disc list-inside mt-1 space-y-1 text-blue-700">
                <li>Pastikan informasi paket lengkap dan akurat.</li>
                <li>Harga yang dimasukkan adalah harga per jamaah.</li>
                <li>Deskripsi akan ditampilkan di halaman detail paket.</li>
            </ul>
        </div>
    </div>

...
{{-- Tangkap Pesan Success atau Error --}}
    ...
    <!-- Hero Section -->
    <section id="home" class="pt-16 bg-gradient-to-r from-orange-600 to-orange-500 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
            <div class="text-center">
                <h1 class="text-4xl md:text-6xl font-bold mb-6">Wujudkan Impian Umroh Anda</h1>
                <p class="text-xl md:text-2xl mb-8">Bersama PT Fabi Abadi, perjalanan ibadah Anda adalah prioritas kami</p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('registration.form') }}" class="bg-white text-orange-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">Daftar Sekarang</a>
                    <a href="#paket" class="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-orange-600 transition">Lihat Paket</a>
                </div>
            </div>
        </div>
    </section>
